...
s	                        	<div class="form-group">
	                        	...
	                        	<div class="form-group">
	                        		<label>Title</label> <input class="form-control" type="text" name="title" value="<c:out value='${board.title }'/>">
	                        	</div>
	                        	<div class="form-group">
	                        	...
	                        	<button class="btn btn-default" data-oper="remove" type="submit">Modify</button>
	                        	<button class="btn btn-default" data-oper="list" type="submit">List</button>
                        	</form>
						</div>
						<!--  end panel body -->
					</div>
